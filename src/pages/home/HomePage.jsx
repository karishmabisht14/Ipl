  ...
  return (
    <Content>
      ...
      >
        <Carousel autoplay style={{ height: "700px" }}>
          <div>
            <Image
              ...
              width={"100%"}
              height={700}
              src="assets\home\crouselPhotos\C5.png"
            />
          </div>
          <div>
            <Image
              ...
              width={"100%"}
              height={700}
              src="assets\home\crouselPhotos\C4.png"
            />
          </div>
          <div>
            <Image
              ...
              width={"100%"}
              height={700}
              src="assets\home\crouselPhotos\C3.png"
            />
          </div>
          <div>
            <Image
              ...
              width={"100%"}
              height={700}
              src="assets\home\crouselPhotos\C2.png"
            />
          </div>
          <div>
            <Image
              ...
              width={"100%"}
              height={700}
              src="assets\home\crouselPhotos\C1.png"
            />
          </div>
        </Carousel>
        <Card
        ...
        <Typography.Title
          level={2}
          style={{ textAlign: "center", fontStyle: "italic", color: "#1d1d1d" }}
        >
          {" "}
