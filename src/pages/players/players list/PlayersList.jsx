...
const PlayerList = ({
  ...
  return (
    <>
      <PermissionButton allowedPermissions={["addPlayer"]}>
        <Button
          type="primary"
      ...
      >
        <div style={{ backgroundColor: "#A7C7E7", padding: "8px 16px" }}>
          <Meta
            ...
            title={
              <Typography.Title level={4}>{player.playerName}</Typography.Title>
            }
          ...
          >
            <PermissionButton allowedPermissions={["editPlayer"]}>
              <EditOutlined
                key="edit"
                onClick={() => {
                  initCreateUpdate(player.playerId);
                  showModal();
                }}
                style={{ marginRight: "8px" }}
              />
            </PermissionButton>
            <PermissionButton allowedPermissions={["deletePlayer"]}>
              <DeleteOutlined
                key="delete"
