...
const TeamList = ({
  ...
  const initCreateUpdate = (id) => {
    if (id === undefined) {
      ...
      const teamObj = teams?.find((team) => team.team_id === id);
  ...
  return (
    <>
      <PermissionButton allowedPermissions={["addTeam"]}>
        <Button
          type="primary"
      ...
      <img
        src="assets\teams\logo\ipl-logo.png"
        width={180}
        style={{ margin: "40px 652px" }}
        alt="IPL"
      />
      ...
      >
        ...
        >
          <Meta
            ...
            title={
              <Typography.Title level={4}>{team.team_name}</Typography.Title>
            }
          />
          <Flex
            style={{
          ...
          >
            <PermissionButton allowedPermissions={["editTeam"]}>
              <EditOutlined
                key="edit"
                onClick={() => {
                  initCreateUpdate(team.team_id);
                  showModal();
                }}
